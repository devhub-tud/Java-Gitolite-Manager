 ...
 * {@link nl.tudelft.ewi.gitolite.config.util.RecursiveStreamingGroup#getOwnGroupsStream()} of the same type.
 * The {@link StreamingGroup#getMembersStream()} should return both the
 * {@link nl.tudelft.ewi.gitolite.config.util.RecursiveStreamingGroup#getOwnMembersStream() own} members as the members

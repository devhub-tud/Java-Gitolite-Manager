 ...
 */
@EqualsAndHashCode
public class RepositoryRule implements Writable {
	 ...
	 * @see RepositoryRule#RepositoryRule(Permission, String, InlineUserGroup)
	 */
	public RepositoryRule(final Permission permission, final Identifiable... identifiable) {
	 ...
	 * @see RepositoryRule#RepositoryRule(Permission, String, InlineUserGroup)
	 */
	public RepositoryRule(final Permission permission, final GroupRule... identifiable) {
		this(permission, new InlineUserGroup(identifiable));
	}

	public RepositoryRule(final Permission permission, final InlineUserGroup members) {
	 ...
	 * @see RepositoryRule#RepositoryRule(Permission, String, InlineUserGroup)
	 */
	public RepositoryRule(final Permission permission, String refex, final Identifiable... identifiable) {
		this(permission, refex, new InlineUserGroup(identifiable));
	}

	public RepositoryRule(final Permission permission, final String refex, final InlineUserGroup members) {
